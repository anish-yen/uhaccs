  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="relative h-[420px] w-[300px]">
        {/* Background PNG Image with Fallback */}
          ...
          <div className="relative h-full w-full">
            <Image
              ...
              onError={(e) => {
                ...
                if (container) {
                  const fallback = container.querySelector(".fallback-body") as HTMLElement
                  if (fallback) {
            ...
            />
            {/* Fallback SVG body outline if PNG doesn't exist */}
            <div className="fallback-body absolute inset-0 hidden flex-col items-center justify-center rounded-lg border border-border bg-secondary/10 text-center text-xs text-muted-foreground">
              ...
              <p className="text-[10px] opacity-70">
                Place body-{gender}-{view}.png in /public
              </p>
            </div>
          </div>
        </div>
